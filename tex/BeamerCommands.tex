...
\definecolor{kSupervised}{RGB}{220,0,78}
\definecolor{kUnsupervised}{RGB}{43,148,166}
\definecolor{kReinforcement}{RGB}{233,112,37}
%==============================================
% Soti's colors
%==============================================
...
\definecolor{MatrixMethodRateColor}{RGB}{236,245,228}
\definecolor{MatrixMethodCalcColor}{RGB}{218,226,252}
% Marina's color
...
\setbeamercolor{title}{fg=\MyMainTextColour, bg=white}
  ...
  \ifbool{SubsectionBullets}{%
    ...
    \setbeamertemplate{headline}{%
      ...
      \begin{beamercolorbox}[ht=0.8cm, wd=1.0\paperwidth, dp=\FooterBoxDepth,leftskip=\LeftSkip, rightskip=\RightSkip]{section in head/foot}
        ...
        \vspace{-0.25cm}
        %\tikz{ \Large
        %  \overlaynode<\MySubsectionColour,{\MyMainTextColour,xshift=1}>{{\textbf{\insertsectionhead}}};} %\insertsubsectionhead%SOTI
        %\tikz{ \large
        %  \overlaynode<white,{\MyMainTextColour,xshift=1}>{{\textbf{\insertsubsectionhead}}};} %\insertsubsectionhead%SOTI
      ...
      \begin{tikzpicture}        
        \hspace{0.5cm} \shade[left color=\MySectionColour!80, right color=\MySectionColour!1,] (0,0) rectangle (13,0.02);
      \end{tikzpicture}
    }
  }
  %%% Footer
...
\newcommand{\NoteFill}[4][180]% [angle], content
           {%
             \begin{tikzpicture}[overlay]
               %\node[align=center, fill=#2, draw,
                 %text=\MySubsectionTextColour,
...
\newcommand{\DataDrivenTag}{\Note[180]{kHLTausRed}{Data driven}{rectangle callout}}
...
\newcommand{\ThisTalkTag}{\Note[180]{kHLTausRed}{This Talk}{rectangle callout}}
\newcommand{\ThisAnalysisTag}{\Note[180]{kGreen}{This Analysis}{rectangle callout}}
\newcommand{\ResolvedTag}{\Note[180]{kHLTausBlue}{resolved}{rectangle callout}}
%\newcommand{\TTMCTag}{\Note[180]{kDarkGreen}{\normalsize
%    \lowercase{$t\bar{t}$} MC}{rectangle callout}}
...
\newcommand{\TTTag}{\Note[180]{kBlue}{\normalsize \lowercase{$t\bar{t}$-like}}{rectangle callout}}
\newcommand{\GenTag}{\Note[180]{kHLTausBlue}{Gen-level}{rectangle callout}}

% EXO-21-002
\newcommand{\AdvancedCatTag}{\NoteFill[180]{kGreen}{204 categories}{rectangle callout}}
\newcommand{\FundamentalCatTag}{\NoteFill[180]{kGreen}{43 categories}{rectangle callout}}
\newcommand{\EXOMultiLeptonTag}{\NoteFill[180]{kBlue}{\href{https://journals.aps.org/prd/pdf/10.1103/PhysRevD.105.112007}{\large PRD 105 (2022), 112007}}{rectangle callout}}
\newcommand{\mossf}{\ensuremath{M_{\text{OSSF}}}\xspace}
\newcommand{\nbj}{\ensuremath{N_{b}}\xspace}
\newcommand{\nj}{\ensuremath{N_{\mathrm{j}}}\xspace}
\newcommand{\ptmiss}{\ensuremath{\pT^\text{miss}}\xspace}

\newcommand{\SUSMultiLeptonJetTag}{\NoteFill[180]{kBlue}{\href{https://cms.cern.ch/iCMS/analysisadmin/cadilines?line=SUS-23-015}{SUS-23-015}}{rectangle callout}}
